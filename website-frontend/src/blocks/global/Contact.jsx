...
export default function Contact() {
  return (
    <div className="w-full h-fit bg-[#444444c9] p-16 flex sm:flex-row flex-col">
      <iframe
        ...
        className="p-4 sm:w-[50%] w-full"
      ></iframe>
      <div className="sm:w-[50%] w-full bg-slate-200 p-4 flex flex-col justify-center">
